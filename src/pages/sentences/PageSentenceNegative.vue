...
<template>
  <p>
    ...
    и&nbsp;(2.) присоединяет к&nbsp;себе частицу &laquo;<b class="sel">not</b>&raquo; (не)
  </p>
  <p>
  ...
  <p>
    Модальный глагол <b class="time">will</b> сам по&nbsp;себе уже является вспомогательным,
    поэтому может присоединяет к&nbsp;себе <b class="sel">not</b> без дополнительной помощи.
  </p>
      ...
      <div class="border">
        <table>
          <tr v-for="subj in subject" :key="subj">
            <td>{{ subj }}</td>
            <td><u class="time">did</u> <u class="sel">not</u></td>
            <td>expect.</td>
          </tr>
        </table>
      </div>
